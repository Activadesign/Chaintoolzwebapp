...
use Discord\Bot\Commands\HelpCommand;
...
return [
    ...
    |
    | Here are each of the discord bots config parameters.
    |
    | Supported Params:
    |
    | - name: The *chaintoolz* name you would like to refer to your bot as.
    |
    |       - token:    Your discord Bot's Access Token.
                        Refer for more details: https://discord.com/oauth2/authorize?client_id=1294726820138188931
    |                   Example: (string) '1294726820138188931'.
    |
    ...
    */
    'bots' => [
        'mybot' => [
            ...
            'certificate_path' => env('DISCORD_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('DISCORD_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands' => [
    ...
    */
    ...
    |
    */
    'async_requests' => env('DISCORD_ASYNC_REQUESTS', false),
    ...
    | Should be an instance of \discord\Bot\HttpClients\HttpClientInterface
    |
    | Default: GuzzlePHP
    |
    */
    ...
    |
    | Default: https://discord.com/developers/applications/1294726820138188931/information
    |
    */
    'base_bot_url' => null,
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Register discord Global Commands [Optional]
    |--------------------------------------------------------------------------
    |
    ...
    |
    | The command class should extend the \discord\Bot\Commands\Command class.
    |
